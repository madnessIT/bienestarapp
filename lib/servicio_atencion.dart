...
class _ServiciosAtencionPageState extends State<ServiciosAtencionPage> {
  ...
  Future<void> _fetchServicios(String fecha, String departamentoId) async {
    // Construimos la URL con los parámetros de fecha y departamento
    var url = Uri.parse('http://test.api.movil.cies.org.bo/administracion/servicios_by_departamento_fecha/?fecha=$fecha&departamento_id=$departamentoId');
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  onTap: () {
                    // Navegar a la siguiente pantalla para elegir el servicio específico
                  },
                );
              },
            ),
